...
int main() {
	...
	int count = 0;
	for(Point point : points)  {
		// conside 'point' as pivot and calculate #rightAngledTriangles 
		// which are axis parallel

		// int a = 0; // to store count of points in 2D plane that has same
		// 		   // x-coordinate as 'point'

		// int b = 0; // to store count of points in 2D plane that has same
		// 		   // y-coordinate as 'point'
		// for(Point p : points) {
		// 	if(p.x == point.x) {
		// 		a++;
		// 	}
